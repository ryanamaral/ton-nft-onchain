import { Address, beginCell, Cell, Contract, contractAddress, ContractProvider, Sender, SendMode, TupleItemInt, TupleBuilder } from '@ton/core';
...
export class NftCollection implements Contract {
    ...
    async getNftContent(provider: ContractProvider, index: number, individual_nft_content: Cell) {
        ...
        return { content: result.readCell() };
    }
}
